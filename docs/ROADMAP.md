...
| 0016 | D3D12 呈现导入器（Windows 零拷贝） | 呈现 | 代码已从源工程搬入，接缝适配与交叉编译待做（见 `docs/platform-port.md`） |
| 0017 | Vulkan dma-buf 导入器与随包 Vulkan Layer（Linux 零拷贝） | 呈现 | 代码已从源工程搬入，接缝适配与交叉编译待做（见 `docs/platform-port.md`） |
